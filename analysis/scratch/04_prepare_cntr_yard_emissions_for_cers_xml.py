...
cntr_emisquant_yards_fac_info = (
    cntr_emisquant_yards_2020.filter(items=facilitysite_fil_cols)
    .drop_duplicates()
...
cntr_emisquant_yards_emisssions_a = cntr_emisquant_yards_2020.assign(
...
cntr_emisquant_yards_emisssions = pd.concat(
    [cntr_emisquant_yards_emisssions_a, cntr_emisquant_yards_emisssions_o3d]
).reset_index(drop=True)
