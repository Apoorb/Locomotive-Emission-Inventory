...
uncntr_emisquant_yards_fac_info = (
    uncntr_emisquant_yards_2020.filter(items=facilitysite_fil_cols)
    .drop_duplicates()
...
uncntr_emisquant_yards_emisssions_a = uncntr_emisquant_yards_2020.assign(
...
uncntr_emisquant_yards_emisssions_o3d = (
    uncntr_emisquant_yards_2020.loc[
...
uncntr_emisquant_yards_emisssions = pd.concat(
    [uncntr_emisquant_yards_emisssions_a, uncntr_emisquant_yards_emisssions_o3d]
).reset_index(drop=True)
