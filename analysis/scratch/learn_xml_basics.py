...
all_counties = templ_root.findall("./header:Payload/payload:CERS/payload:Location", ns)
...
county_new = templ_root.findall(
    "./header:Payload/payload:CERS/payload:Location"
    "/[payload:StateAndCountyFIPSCode='99999']",
    ns,
)
...
for statefips in templ_root.iter(
    "{http://www.exchangenetwork.net/schema/cer/1}StateAndCountyFIPSCode"
):
