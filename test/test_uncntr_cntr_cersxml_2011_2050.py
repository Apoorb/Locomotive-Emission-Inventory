...
from locoerlt.uncntr_cntr_cersxml_2011_2050 import (
...
def test_cntr_input_output_data_equal(year):
    path_out_cntr_fi = os.path.join(path_out_cntr, f"cntr_{year}_TexAER.xml")
    cntr_tree = ET.parse(path_out_cntr_fi)
